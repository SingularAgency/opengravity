...
export async function runAgentLoop(conversationId, userMessage) {
    ...
    while (iteration < maxIterations) {
        ...
        const responseMessage = response.choices?.[0]?.message || response.message; // Handle groq SDK or general openrouter format
        if (!responseMessage) {
